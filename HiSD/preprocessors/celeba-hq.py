...
# python celeba-hq.py --img_path /root/autodl-tmp/img_align_celeba --label_path /root/autodl-tmp/list_attr_celeba.txt --target_path /root/tf-logs/FOUND_code/datasets --start 3002 --end 30002
